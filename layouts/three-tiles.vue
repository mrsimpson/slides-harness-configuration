<template>
  <div class="slidev-layout three-tiles">
    <!-- Header Section -->
    <div class="header-section text-center pt-4 pb-2">
    ...
    <!-- Three Tiles Grid -->
    <div class="tiles-section p-4">
      <div class="grid grid-cols-3 gap-4 h-full">
        <!-- Tile 1 -->
        <div class="tile flex flex-col items-center justify-center text-center p-4">
